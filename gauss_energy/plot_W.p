...
set style line 1    lw 2       lc rgb '#b80707'; # SYM Energy
set style line 2    lw 2 dt 2  lc rgb '#b87107'; # SYM RSPT2
set style line 3    lw 2       lc rgb '#b87107'; # SYM RSPT3
set style line 4    lw 2 dt 2  lc rgb '#b8af07'; # SYM ENPT2
set style line 5    lw 2       lc rgb '#b8af07'; # SYM ENPT3
set style line 6    lw 2       lc rgb '#072ab8'; # ASYM Energy
set style line 7    lw 2 dt 2  lc rgb '#ad58d1'; # ASYM RSPT2
set style line 8    lw 2       lc rgb '#ad58d1'; # ASYM RSPT3
set style line 9    lw 2 dt 2  lc rgb '#de68b9'; # ASYM ENPT2
set style line 10   lw 2       lc rgb '#de68b9'; # ASYM ENPT3
