...
plot 0 w lines ls 7 title '', \
     'out_64_new/out_l-0.50'    u 1:(abs(1000*($8-$2)/$2)) w linespoints pt 6 lw 3 lc rgb '#01400C' ps 1.5 title '$\lambda = -0.5$',\
     'out_64_new/out_l-1.00'    u 1:(abs(1000*($8-$2)/$2)) w linespoints pt 7 lw 3 lc rgb '#01400C' ps 1.5 title '$\lambda = -1.0$',\
     'out_64_new/out_l0.50'     u 1:(abs(1000*($8-$2)/$2)) w linespoints pt 4 lw 3 lc rgb '#70c27e' ps 1.5 title '$\lambda = 0.5$',\
     'out_64_new/out_l1.00'     u 1:(abs(1000*($8-$2)/$2)) w linespoints pt 5 lw 3 lc rgb '#70c27e' ps 1.5 title '$\lambda = 1.0$';
