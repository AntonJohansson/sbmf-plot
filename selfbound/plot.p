...
set label 1 front '\textcolor{dred}{\footnotesize{$\gamma = -0.90$}}'   at graph 0.41, 0.59
...
plot    \
        'out_0.005000_gab_-0.900000'  u 1:(0.5*scale*$3/$1):(0.5*scale*($4-($3-$4))/$1) w filledcurve fc rgb '#f5a7a3' title '', \
        'out_0.005000_gab_-0.900000'  u 1:(0.5*scale*$5/$1):(0.5*scale*($6-($5-$6))/$1) w filledcurve fc rgb '#ed655e' title '', \
        'out_0.005000_gab_-0.900000'  u 1:(0.5*scale*$4/$1)  w linespoints ls 3 title '\footnotesize{RSPT3}', \
        'out_0.005000_gab_-0.900000'  u 1:(0.5*scale*$6/$1)  w linespoints ls 5 title '\footnotesize{ENPT3}', \
        ...
        'out_0.005000_gab_-0.950000'  u 1:(0.5*scale*$4/$1)  w linespoints ls 3 title '', \
        'out_0.005000_gab_-0.950000'  u 1:(0.5*scale*$6/$1)  w linespoints ls 5 title '', \
